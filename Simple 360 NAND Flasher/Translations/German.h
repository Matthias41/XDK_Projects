...
#define MSG_UNABLE_TO_WRITE_BYTES_TO_FLASH "Nicht in der Lage zu schreiben 0x%X bytes to flash, Fehler: 0x%X Offset: 0x%X"
...
#define MSG_DONE_SUCCESS_DUMPED_BYTES "\rFertig! Erfolgreich gelesen 0x%X bytes to %s\n"
#define MSG_DONE_READ_BYTES_FROM_NAND_WROTE "\rFertig! gelesen 0x%X bytes vom NAND, geschrieben 0x%X bytes zu %s\n"
#define MSG_DONE_SUCCESS_WROTE_BYTES "Erfolgreich geschrieben 0x%X bytes vom %s zum Flash!\n"
